...
;(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.billing-cycle-radios').on('click', function () {
      if ($('.billed-dollar-radio input').is(':checked')) {
        $('.pricing-plans-container').addClass('billed-dollar')
      }
      if ($('.billed-naira-radio input').is(':checked')) {
        $('.pricing-plans-container').removeClass('billed-dollar')
      }
    })
